...
| **Network Event Classification** | Identifying the root cause of failures (hardware vs. software vs. attack) based on patterns in logs and headers. (Here doesnt contains dataset, it is research paper)| [IEEE Failure Type Research](https://ieeexplore.ieee.org/document/9474482) |
